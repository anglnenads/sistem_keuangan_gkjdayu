...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="81"><ion-icon name="bar-chart"></ion-icon> &nbsp; Dashboard Gereja</a></li>
                            <li><a class="dropdown-item" href="82"><ion-icon name="bar-chart"></ion-icon> &nbsp; Dashboard Bidang Komisi</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    switch ($link) {
        ...
        case 281:
            if ($status_aktif_fiskal == 1) {
                include("incFormPengeluaranGereja.php");
            } else {
                include("incHome.php");
            }
            break;
        ...
        case 282:
            if ($status_aktif_fiskal == 1) {
                include("incFormPemindahanDana.php");
            } else {
                include("incHome.php");
            }
            break;
        ...
        //Dashboard
        case 81:
            include("incDashGereja.php");
            break;
        case 82:
            include("incDashBidKom.php");
            break;
