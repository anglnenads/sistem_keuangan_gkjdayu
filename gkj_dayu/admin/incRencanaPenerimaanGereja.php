...
if (!empty($_POST["editbtn"])) {
    ...
    $datafield = array("id_fiskal", "id_akun", "jumlah_penerimaan");
    $datavalue = array($id_fiskal,  $_POST['id_akun'], $_POST['jumlah_penerimaan']);

    $datakey = ' id_rencana =' . $_POST["id_rencana"];

    $update = new cUpdate();
    $update->vUpdateData($datafield, "rencana_penerimaan_gereja", $datavalue, $datakey, $linkurl);
}
