...
if (isset($_SESSION['komisi']) || isset($_SESSION['bidang'])) {
    ...
    $tabelcaption1 = '<tr style="text-align: center; font-weight:bold;">
                        <td rowspan="2" colspan="8" width="100%" class="text-center">RENCANA PENERIMAAN</td> 
                    </tr> 
                    <tr></tr> 
    ...
    $title2 = '<h3 style="text-align: center;">LAPORAN RENCANA  '.  strtoupper($bidangKomisi) . '</h3>';
    ...
    $tabelcaption = '<tr style="text-align: center; font-weight:bold;">
                        <td rowspan="2" colspan="8" width="100%" class="text-center">RENCANA PENGELUARAN</td> 
                    </tr> 
                    <tr> </tr> 
    ...
    $tabelcaption = '<tr style="text-align: center; font-weight:bold">
                        ...
                        <td colspan="3" width="30%" class="text-center">Rencana Penerimaan</td>
                        <td colspan="3" width="30%" class="text-center">Rencana Pengeluaran</td>
                    </tr>
    ...
    $title1 = '<h2 style="text-align: center;">GEREJA KRISTEN JAWA DAYU</h2>';
    $title2 = '<h3 style="text-align: center;">REKAPITULASI RENCANA KOMISI</h3>';
    $title3 = '<h3 style="text-align: center;">' . $laporan . '</h2>';
    $titleLaporan =  $title1 . $title2 . $title3;
