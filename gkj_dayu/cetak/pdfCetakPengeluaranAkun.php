...
$tabelcaption = '<tr style="text-align: center; font-weight:bold">
                    ...
                    <td width="42%">Rencana Pengeluaran</td>
                    <td width="18%">Realisasi Pengeluaran</td>
                </tr>
...
$pdf->SetTitle('Laporan Rekapitulasi Anggaran Pengeluaran Gereja');
...
$pdf->Cell(0, 10, 'REKAPITULASI PENGELUARAN GEREJA', 0, 1, 'C');
